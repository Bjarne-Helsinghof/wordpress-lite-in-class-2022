<template>
    <div>
        ...
        <v-btn id="floatyClose" rounded="0" size="large" color="warning" class="bg-yellow-lighten-3 pa-3 my-1"
            @click="$emit('close')">
        ...
        <v-card class="my-5 pa-5 bg-white rounded" elevation="1">
            ...
            <v-row>
                <v-col>
                    <v-btn class="bg-green-lighten-3" @click="firebaseAddSingleItem(description)">Add Dynamic Item
                    </v-btn>
                </v-col>
            </v-row>
